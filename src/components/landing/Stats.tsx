            ...
            <div className="container mx-auto px-6 max-w-5xl space-y-16">
                <div className="text-center space-y-3">
                    ...
                    <p className="text-neutral-400 text-sm md:text-base max-w-xl mx-auto">
                        Performance benchmarks mapping reliable operations
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {statsList.map((stat, idx) => (
                        <div
                            key={`stat-${idx}`}
                            className="text-center space-y-2 p-6 rounded-xl bg-neutral-900/30 border border-neutral-900 hover:border-neutral-800 transition-all"
                        >
                            <div className="text-3xl md:text-4xl font-extrabold tracking-tight text-indigo-500">
                                {stat.value}
                            </div>
                            <div className="space-y-0.5">
                                <p className="text-sm font-bold tracking-tight text-neutral-200">
                                    {stat.label}
                                </p>
