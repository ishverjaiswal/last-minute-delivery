...
export default function CreateOrderPage() {
    ...
    useEffect(() => {
        ...
        const matchedRate = rates.find(
            (r) => watchedWeight >= r.minWeight && watchedWeight <= r.maxWeight
        )
    ...
    const fillSampleOrder = () => {
        setValue('senderName', DEMO_DATA.customer.name, {
            shouldValidate: true,
        })
        setValue('senderPhone', DEMO_DATA.customer.phone, {
            shouldValidate: true,
        })
        setValue('pickupAddress', DEMO_DATA.customer.pickupAddress, {
            shouldValidate: true,
        })
        setValue('recipientName', DEMO_DATA.customer.recipientName, {
            shouldValidate: true,
        })
        setValue('recipientPhone', DEMO_DATA.customer.recipientPhone, {
            shouldValidate: true,
        })
        setValue('deliveryAddress', DEMO_DATA.customer.deliveryAddress, {
            shouldValidate: true,
        })
        setValue('deliveryPinCode', DEMO_DATA.customer.pin, {
            shouldValidate: true,
        })
        setValue('weight', DEMO_DATA.customer.weight, { shouldValidate: true })
        setValue('category', DEMO_DATA.customer.packageCategory, {
            shouldValidate: true,
        })
        setValue('specialInstructions', DEMO_DATA.customer.notes, {
            shouldValidate: true,
        })
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <p className="premium-tyo-secondary">
                        Create a parcel shipment and receive an estimated
                        delivery cost.
                    </p>
                </div>
                <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="premium-form-group">
                                ...
                                {errors.senderName && (
                                    <p className="premium-form-error">
                                        {errors.senderName.message as string}
                                    </p>
                                )}
                            </div>
                            <div className="premium-form-group">
                                ...
                                {errors.senderPhone && (
                                    <p className="premium-form-error">
                                        {errors.senderPhone.message as string}
                                    </p>
                                )}
                            </div>
                            <div className="premium-form-group md:col-span-2">
                                ...
                                {errors.pickupAddress && (
                                    <p className="premium-form-error">
                                        {errors.pickupAddress.message as string}
                                    </p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="premium-form-group md:col-span-2">
                                <label
                                    ...
                                    className="premium-form-label"
                                >
                                    Delivery PIN Code (Kanpur Coverage Range){' '}
                                    <span className="text-red-500">*</span>
                                </label>
                                <input
                                    id="deliveryPinCode"
                                ...
                                {pinCheck.status === 'unavailable' && (
                                    <p className="premium-form-helper text-red-500 font-semibold">
                                        ✕ PIN code {watchedPin} is outside
                                        coverage zone network
                                    </p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 text-xs">
                            ...
                            <div className="flex justify-between py-1.5 border-b border-neutral-855">
                                ...
                                <span className="font-extrabold text-indigo-400 text-sm">
                                    {pinCheck.status === 'available' &&
                                    pinCheck.estimatedCost !== undefined
                        ...
                        {pinCheck.status !== 'available' &&
                            watchedPin.length >= 5 && (
                                <p className="text-[10px] text-center text-red-500 font-semibold">
                                    Booking disabled: Selected PIN code is not
                                    serviceable.
                                </p>
                            )}
                    </div>
